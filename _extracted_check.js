  (() => {
    ...
    const LIGHT_MODE_SCAN_INTERVAL = 0.24;
    const LIGHT_MODE_VISUAL_INTERVAL = 1 / 45;
    const LIGHT_MODE_UI_INTERVAL = 0.22;
    const LIGHT_MODE_CLEANUP_INTERVAL = 0.68;
    const LIGHT_MODE_RESCUE_INTERVAL = 0.78;
    const LIGHT_MODE_BOARD_STATS_CACHE_MS = 380;
    const LIGHT_MODE_PARTICLE_BUDGET = 12;
    const LIGHT_MODE_PARTICLE_SCALE = 0.16;
...
#トレバズ`;
    ...
    updateMuteButtons();
    document.body.classList.add('title-mode');
    try { dom.bgVideo?.pause?.(); dom.bgVideoHype?.pause?.(); } catch (_) {}
    applyAppHeight();
