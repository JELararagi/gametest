  ...
  (() => {
    ...
    const storageKey = 'trendbuzz_v56';
    ...
    const voicePools = {
      start:['assets/audio/voice_mc_start_01.wav','assets/audio/voice_mc_start_02.wav','assets/audio/voice_story_start.wav'],
      warning:['assets/audio/voice_mc_warning_01.wav','assets/audio/voice_mc_warning_02.wav','assets/audio/voice_warning_1.wav','assets/audio/voice_warning_2.wav'],
      clear:['assets/audio/voice_mc_clear_01.wav','assets/audio/voice_mc_clear_02.wav','assets/audio/voice_mc_clear_03.wav','assets/audio/voice_clear_1.wav','assets/audio/voice_clear_2.wav','assets/audio/voice_clear_3.wav'],
      chain:['assets/audio/voice_mc_chain_02.wav','assets/audio/voice_mc_chain_03.wav','assets/audio/voice_mc_chain_04.wav','assets/audio/voice_mc_chain_05.wav','assets/audio/voice_chain_2.wav','assets/audio/voice_chain_3.wav','assets/audio/voice_chain_4.wav','assets/audio/voice_chain_5.wav'],
      hype:['assets/audio/voice_mc_hype_01.wav','assets/audio/voice_mc_hype_02.wav','assets/audio/voice_mc_hype_03.wav','assets/audio/voice_hype_1.wav','assets/audio/voice_hype_2.wav','assets/audio/voice_hype_3.wav'],
      fire:['assets/audio/voice_mc_fire_01.wav','assets/audio/voice_mc_fire_02.wav','assets/audio/voice_ai_hack.wav'],
      win:['assets/audio/voice_mc_win_01.wav','assets/audio/voice_mc_win_02.wav','assets/audio/voice_win.wav'],
      lose:['assets/audio/voice_mc_lose_01.wav','assets/audio/voice_mc_lose_02.wav','assets/audio/voice_lose.wav']
    };
    ...
    function queueRoll() {
      ...
      if (Number.isInteger(state.trendIndex)) {
        weights[state.trendIndex] *= bigBuzz ? 6.2 : 2.35;
      }
      if (Number.isInteger(state.nextTrendIndex)) {
        weights[state.nextTrendIndex] *= state.trendWarning ? (bigBuzz ? 2.2 : 1.7) : 1.14;
      }
